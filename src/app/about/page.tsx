...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "jeelmodiya@gmail.com",
    href: "mailto:jeelmodiya@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/jeel-modiya-a5070b304/",
    content: "/jeel-modiya",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Jeelmodiya",
    content: "/Jeelmodiya",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Jeel Modiya</p>
